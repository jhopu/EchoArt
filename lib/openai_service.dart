...
import 'package:first_ashish/secrets.dart';
...
class OpenAIService{
  ...
  body: jsonEncode({
    ...
    "messages": [
      {
        "role": "user",
        "content": "Does this message want to generate an AI picture,image,art or anthing similar? $prompt .Simply answer with a yes or no",
      },
